...
output apimSystemAssignedIdentityPrincipalId string = apimService.identity.principalId
output apimSystemAssignedIdentityTenantId string = apimService.identity.tenantId
